...
private.EXPANSION8_CURRENCY_IDS = EXPANSION8_CURRENCY_IDS

local EXPANSION9_CURRENCY_IDS = {
	2118, --元素涌流
	2003, --巨龙群岛补给
	2123, --血腥硬币
}
private.EXPANSION9_CURRENCY_IDS = EXPANSION9_CURRENCY_IDS
