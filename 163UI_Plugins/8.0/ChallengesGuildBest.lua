...
CoreDependCall("Blizzard_ChallengesUI", function()
    ...
    local drops  = { nil, 262, 265, 268, 272, 275, 275, 278, 278, 281, 281, 285, 285, 288, 288, 288, 288, 288, 288, 288, 288,  }
    local levels = { nil, 278, 278, 278, 281, 281, 285, 288, 288, 291, 294, 298, 298, 301, 304, 304, 304, 304, 304, 304, 304,  }
