...
-------------------------------------------------------------------------------]]
local Type, Version = "TomCatsLabel", 1
    ...
    if self.imageshown then
        ...
        if (label:GetText() or "") == "" then
            ...
            if image:GetHeight() > label:GetHeight() then
                ...
                label:SetPoint("TOPLEFT", image, "TOPRIGHT", 5, 0)
            end
...
local methods = {
    ...
    ["SetFontObject"] = function(self, font)
        ...
        self.label:SetVertexColor(font:GetTextColor())
    end,
    ...
    ["GetMinWidth"] = function(self)
        if self.image and self.label then
            return self.image:GetWidth() + self.label:GetStringWidth()
