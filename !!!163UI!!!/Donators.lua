...
local recentDonators = {["血色十字军"] = "Tf,因芸;TZ,不信鬼神",["瓦丝琪"] = "Tf,小瓶盖儿",["霜之哀伤"] = "Te,瑞灬弑",["回音山"] = "Te,翼雪",["影之哀伤"] = "Te,苍烟断",["风暴之怒"] = "Te,天然元素",["死亡之翼"] = "Te,丶蟹棒好吃;Td,离人丶泪;Tb,卩灬聖丨光",["冰风岗"] = "Te,帅帅滴板砖酱;Td,天韵五五",["主宰之剑"] = "Te,無上菩提",["伊森利恩"] = "Te,铁了心爱你,小紅仁",["亡语者"] = "Te,云淡心晴",["凤凰之神"] = "Te,丶虚竹丶;Td,梦霜宇,小妞向前冲;Tc,终极版本答案;Tb,艾梅特赛尔克",["罗曼斯"] = "Td,因为蛋疼所以",["格瑞姆巴托"] = "Td,可乐灬乄;Tb,一云丶",["世界之树"] = "Td,Stillalive",["贫瘠之地"] = "Tc,布利瑞斯;Tb,婲落知多少丶",["白银之手"] = "Tc,有德必尸,砸瓦鲁多;Tb,蛋壳总是脆,缺德萌咕;Ta,为妳念咒;TZ,安牧茜",["凯恩血蹄"] = "Tc,闪伯利恒之星",["罗宁"] = "Tc,夏多雷希尔兔,佰寶",["瓦里安"] = "Tc,陈年老号",["迅捷微风"] = "Tc,扶桑啊大红花",["银松森林"] = "Tc,樱桃",["朵丹尼尔"] = "Tc,Miuinitio",["海克泰尔"] = "Tb,叮噹咕嚕",["迦拉克隆"] = "Tb,希望的灯火",["末日行者"] = "Tb,野蛮丨大疯子",["无尽之海"] = "Ta,罒壹罒",["白骨荒野"] = "Ta,羽月希丶,幻之地狱",["克尔苏加德"] = "TZ,清妤,八度余温"};
