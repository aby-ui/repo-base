...
local function stupefyingGlareLoop(self)
	...
	local timer = self:IsMythic() and mythicTimers[self.vb.phase][317874][self.vb.stupefyingGlareCount+1] or self:IsHeroic() and heroicTimers[self.vb.phase][317874][self.vb.stupefyingGlareCount+1] or self:IsEasy() and normalTimers[self.vb.phase][317874][self.vb.stupefyingGlareCount+1]
	if timer then
...
function mod:SPELL_CAST_SUCCESS(args)
	...
	elseif spellId == 317102 then
		...
		local timer = self:IsMythic() and mythicTimers[self.vb.phase][317102][self.vb.evokeAnguishCount+1] or self:IsHeroic() and heroicTimers[self.vb.phase][317102][self.vb.evokeAnguishCount+1] or self:IsEasy() and normalTimers[self.vb.phase][317102][self.vb.evokeAnguishCount+1]
		if timer then
