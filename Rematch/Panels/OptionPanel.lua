...
panel.opts = {
	...
	{ "check", "DebugDelayMacs", L["Debug: Delay Journal On Macs"]..newIcon, L["On MacOS clients, delay Rematch taking over the journal on the first launch by half a second."] },
