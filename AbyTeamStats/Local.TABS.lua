...
TS.DATA_VERSION = 20221215

--abyuiPW
TS.VERSION_BOSSES = { -15470, "狱", -17107, "龙" } -- -14460, "帝", -15134, "希", -13784, "艾", -14068, "恩", -13322, "吉", -13418, "乌", 12110, "阿" -11874, "基" -- -11195, "古", --引领潮流 -11194, "萨", -11581, "海", 引领潮流：Ahead of the Curve: 千钧一发 Cutting Edge:

local FIRST_TAB = {
    tab = "总览",
    ids = { -16649, -16650 }, -- { -15690, {-15692,-15693,-15694,-15695,-15500} } "S4大师", "钥石英雄" "钥石英雄光辉成就（账号共享，限时完成20层史诗钥石副本，第四赛季集市、卡拉赞、麦卡贡、码头、车站共5个）", -- -15498, -15499, "S3征服", "S3大师" -15077, -15078, "S2征服", "S2大师" -14531, -14532, "S1征服", "S1大师", -14145, "S4大师", -13781, "S3大师", -13449, "S2大师"
    widths = { 54, 54 },
    names = { "S1大师", "S1英雄", },
    tips = { "钥石大师（账号共享，任意角色史诗钥石评分2000分）", "钥石大师（账号共享，任意角色史诗钥石评分2500分）"},
    reports = { false, false, },
}
...
local INSTANCES = {
    {
        bosses = {
            { "艾拉诺格", 16371, 16379, { 16387, -16346, }, },
            { "泰洛斯", 16372, 16380, { 16388, -16347, }, },
            { "原始议会", 16373, 16381, { 16389, -16348, }, },
            { "瑟娜尔丝，冰冷之息", 16374, 16382, { 16390, -16349, }, },
            { "晋升者达瑟雅", 16375, 16383, { 16391, -16350, }, },
            { "库洛格·恐怖图腾", 16376, 16384, { 16392, -16351, }, },
            { "巢穴守护者迪乌尔娜", 16377, 16385, { 16393, -16352, }, },
            { "莱萨杰丝", 16378, 16386, { 16394, -16353, }, },
        },
        diff = { "巨龙牢窟", "英雄", "史诗", },
        tab = "化身巨龙牢窟",
    },
...
table.insert(TABS, {
    ...
    specialIDs = { 0, 402, 399, 401, 400, 165, 210, 200, 002, },
    widths = { 64, 58, 58, 58, 58, 58, 58, 58, 58, },
    tips = { "", tip, tip, tip, tip, tip, tip, tip, tip, },
    names = { "总分", "学院", "红玉", "碧蓝", "诺库德", "影月",  "群星", "英灵殿", "青龙寺", },
})
...
table.insert(TABS, {
    ...
    any_done = true,
    ids = {
        {-17108}, {-15471}, {-15135}, {-14461}, {-14069}, {-13785}, {-13419}, {-13323}, {-12535},
        {-12111}, {-11875}, {-11192}, {-11580}, {-11191},
        {-10045}, {-9443}, {-9442},
        {-8401, -8400}, {-8260}, {-8238}, {-7487}, {-7486}, {-7485},
    },
    widths = { 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, },
    tips = {
        "千钧一发：噬雷之龙", "千钧一发：典狱长", "千钧一发：希尔瓦娜斯", "千钧一发：德纳修斯大帝", "千钧一发：恩佐斯", "千钧一发：艾萨拉", "千钧一发：乌纳特", "千钧一发：吉安娜", "千钧一发：戈霍恩",
    ...
    names = { "噬雷", "典狱", "希瓦", "大帝", "恩佐", "艾萨", "乌纳", "珍娜", "戈霍", "阿古", "基丹", "古尔", "海拉", "萨维", "阿克", "黑手", "悬槌", "小吼", "莱登", "雷神", "永春", "恐心", "魔古" },
})
