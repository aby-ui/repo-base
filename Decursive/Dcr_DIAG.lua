...
local VERSION = "2.7.8.12-1-g2f5d2c9";
...
do
    ...
    local function setReportHeader(fromDiag)
        ...
        DebugHeader = ("%s\n2.7.8.12-1-g2f5d2c9  %s(%s)  CT: %0.4f D: %s %s %s BDTHFAd: %s nDrE: %d Embeded: %s W: %d (LA: %d TAMU: %d) TA: %d NDRTA: %d BUIE: %d TI: [dc:%d, lc:%d, y:%d, LEBY:%d, LB:%d, TTE:%u] (%s, %s, %s, %s)"):format(instructionsHeader, -- "%s\n
...
T._LoadedFiles["Dcr_DIAG.lua"] = "2.7.8.12-1-g2f5d2c9";
