...
function D:VersionWarnings(forceDisplay) -- {{{
    ...
    if DcrMaxTOC < T._tocversion then
        ...
        elseif time() - self.db.global.TocExpiredDetection > 3600 * 24 * 40 then -- if more than 40 days elapsed since the detection
            ...
            if time() - self.db.global.LastExpirationAlert > 48 * 3600 or forceDisplay then
                ...
                T._ShowNotice ("|cff00ff00Decursive version: 2.7.8.12-2-g8a095be|r\n\n" .. "|cFFFFAA66" .. L["TOC_VERSION_EXPIRED"] .. "|r");
    ...
    if (("2.7.8.12-2-g8a095be"):lower()):find("beta") or ("2.7.8.12-2-g8a095be"):find("RC") or ("2.7.8.12-2-g8a095be"):find("Candidate") or alpha then
        ...
        if self.db.global.NonRelease ~= "2.7.8.12-2-g8a095be" then
            self.db.global.NonRelease = "2.7.8.12-2-g8a095be";
...
T._LoadedFiles["DCR_init.lua"] = "2.7.8.12-2-g8a095be";
