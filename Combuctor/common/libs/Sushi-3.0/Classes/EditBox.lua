<<<<<<< HEAD:Combuctor/common/libs/Sushi-3.0/Classes/EditBox.lua
--[[
...
function EditBox:UpdateFonts()
	...
	self.Label:SetFontObject(font:format('Normal') .. (self:IsSmall() and 'Small' or ''))
	self:SetFontObject(font:format('Highlight') .. 'Small')
>>>>>>> 0c4c352d04b9b16e45411ea8888c232424c574e4:Bagnon_Config/common/libs/Sushi-3.0/Classes/EditBox.lua
end