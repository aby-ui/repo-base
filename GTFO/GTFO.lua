...
GTFO = {
	...
	Version = "4.65"; -- Version number (text format)
	VersionNumber = 0; -- Numeric version number for checking out-of-date clients (placeholder until client is detected)
	RetailVersionNumber = 46500; -- Numeric version number for checking out-of-date clients (retail)
	ClassicVersionNumber = 46500; -- Numeric version number for checking out-of-date clients (classic)
	BurningCrusadeVersionNumber = 46500; -- Numeric version number for checking out-of-date clients (TBC classic)
