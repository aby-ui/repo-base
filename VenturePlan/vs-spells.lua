...
T.KnownSpells = {
	...
	[91]={type="aura", target=1, duration=3, plusDamageDealtA=-0.6, desc="使距离最远的敌人造成的伤害降低1点，持续3回合."},
	...
	[85]={type="aura", target=3, duration=2, firstTurn=3, modDamageTaken=-5000, desc="使距离最近的盟友受到的伤害降低5000%，持续2回合."},
