...
V =
    C == "zhCN" and { -- 94/94 (100%)
      ...
      "结果不确定", "受诅咒的冒险指南", "随从匹配指南", "使全部敌人受到负面效果，接下来的{2}轮内每次造成{1}点伤害。此效果可以多次叠加。", "对所有敌人施加负面效果，在此轮和接下来的三轮中分别造成{1}伤害。此外，受到来自最近敌人三轮内的伤害提高{2}。", "失败", "经验队(失败！只吃经验)", "持续时间：", "编辑预设队伍", "每过一轮，一个随机敌人会受到{}％最大生命值的攻击。",
    ...
    or C == "zhTW" and { -- 94/94 (100%)
      ...
      "結果不確定", "受詛咒的冒險指南", "隨從匹配指南", "使全部敵人受到負面效果，接下來的{2}輪內每次造成{1}點傷害。此效果可以多次疊加。", "對所有敵人施加負面效果，在此輪和接下來的三輪中分別造成{1}傷害。此外，受到來自最近敵人三輪內的傷害提高{2}。", "失敗", "經驗隊(失敗！只吃經驗)", "持續時間：", "編輯預設隊伍", "每過一輪，一個隨機敵人會受到{}％最大生命值的攻擊。",
