...
if GetLocale()=="zhCN" then
	...
	BINDING_NAME_DWCBGCHANNEL="聊天条：战场频道发言"
	BINDING_NAME_DWCGUILDCHANNEL="聊天条：公会频道发言"
	BINDING_NAME_DWCYELL="聊天条：大喊"
	BINDING_NAME_DWCWHISPER="聊天条：密聊"
	BINDING_NAME_DWCOFFICER="聊天条：官员频道发言"
end
