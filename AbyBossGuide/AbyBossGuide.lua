...
BG.data = {
    ["围攻伯拉勒斯"] = {
        { id = 2133, name = "拜恩比吉中士", text = "优先击杀小怪，被追赶的人把boss拉到炸弹上，boss晕了有易伤。千万别让剩下的炸弹爆炸，小怪和玩家都可以踩" },
    ...
    ["地渊孢林"] = {
        ...
        { id = 2158, name = "不羁畸变怪", text = "打血肉兽小怪会扣boss的血，孢子躲或者蹭一下清掉，进光圈集合清debuff。简易打法：拉BOSS到一角集中，木桩撸BOSS，远程清一下孢子（boss打越快小怪出越快，交给NPC打，光圈可以清地上的毒）", },
        id = 1022,
    },
    ["塞塔里斯神庙"] = {
