...
BG.data = {
    ["伤逝剧场"] = {
        ...
        [4] = { id = 2389, name = "库尔萨洛克", text = "分散站。被点名绿线的玩家魂会跑出来，尽快追上魂，掉血很快治疗加好。技巧：连线时躲在地上的绿手后面，魂会被手抓住", },
        [5] = { id = 2417, name = "无尽女皇莫德蕾莎", text = "镰刀T减伤。转圈躲射线。出圈时分散6码，炸了打小怪(史诗)。出裂隙不能被吸进去", },
        author = "哚秘书@NGA",
        id = 1187,
    },
    ["凋魂之殇"] = {
    ...
    ["塞兹仙林的迷雾"] = {
        ...
        { id = 2400, name = "英格拉·马洛克", name2 = "宗主奥法兰", text = "先打高的再打矮的", },
    ...
    ["彼界"] = {
        ...
        [2] = { id = 2409, name = "米尔豪斯·法力风暴", name2 = "米尔菲丝·法力风暴", text = "拆炸弹，挡线，女的点名连线晕男BOSS，男的点名紫圈晕女BOSS，不然AOE灭团", },
        [3] = { id = 2398, name = "商人赛·艾柯莎", text = "有啥躲啥，地上白圈踩了可升天，BOSS大招一起升天躲，被点名炸弹自己升天别炸队友", },
        [4] = { id = 2410, name = "穆厄扎拉", text = "BOSS阶段三个动作对应躲左躲右远离。转阶段原左右手下方位置会出门，点门飞走不然必死。分两队打小怪，打完转身点柱子", },
        id = 1188,
    },
    ["晋升高塔"] = {
    ...
    ["通灵战潮"] = {
        ...
        [4] = { id = 2396, name = "缚霜者纳尔佐", text = "白圈远离队友再驱散，躲地上白旋涡，被传送打掉小怪回来后先站角落放水", },
        id = 1182,
    },
--    ["暗影界"] = {
