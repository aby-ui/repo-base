...
BG.data = {
    ...
    ["地渊孢林"] = {
        { id = 2157, name = "长者莉娅克萨", text = "boss前一波小怪先打祭师，boss瞎打", },
        { id = 2131, name = "被感染的岩喉", text = "踩地上的虫子，站位分散点别踩重了", },
        { id = 2130, name = "孢子召唤师赞查", text = "T控制boss冲击波清蘑菇，被点名炸蘑菇，还剩下的就踩吧", },
        { id = 2158, name = "不羁畸变怪", text = "打出来的小怪，进地上光圈清debuff", },
        id = 1022,
    },
    ["塞塔里斯神庙"] = {
    ...
    ["暴富矿区！！"] = {
        { id = 2109, name = "投币式群体打击者", text = "站在炸弹旁调整方向踢到boss上，T拉boss躲钱堆但别乱跑", },
        { id = 2114, name = "艾泽洛克", text = "先杀小怪，BOSS拉离人群，被点名的跑", },
        { id = 2115, name = "瑞克莎·流火", text = "躲黄水，躲吹风，吹风会吹动黄水", },
        { id = 2116, name = "商业大亨拉兹敦克", text = "中导弹的跑远，圈很大。boss上天后引到柱子上方", },
        id = 1012,
    },
    ["维克雷斯庄园"] = {
    ...
    ["自由镇"] = {
        ...
        { id = 2093, name = "海盗议会", text = "BOSS前地图标记对话可以少打一个，BOSS战注意打酒桶救人", },
    ...
    ["诸王之眠"] = {
        { id = 2165, name = "黄金风蛇", text = "水会生小怪，远离boss集中放水，可控可杀", },
        { id = 2171, name = "殓尸者姆沁巴", text = "被埋葬了按1晃棺材，其他人仔细观察尽快救人", },
        { id = 2170, name = "部族议会", text = "依次打3个boss，翻滚需要分担，先打爆炸图腾", },
        { id = 2172, name = "始皇达萨", text = "简单，先杀小怪和坐骑，地上的圈是唬人的", },
        id = 1041,
    },
    ["阿塔达萨"] = {
        { id = 2082, name = "女祭司阿伦扎", text = "在BOSS吸血前进水让boss吸毒血，理想情况下5根红线", },
        { id = 2036, name = "沃卡尔", text = "先同时打掉3个图腾，然后拉着BOSS在外围慢慢移动打，远程站里面", },
        { id = 2083, name = "莱赞", text = "卡视角躲恐惧，地上紫圈踩到就出小怪，也不要让boss踩到", },
        { id = 2030, name = "亚兹玛", text = "躲好蜘蛛，别站的太集中，尽快击杀影子", },
        id = 968,
    },
    ["风暴神殿"] = {
