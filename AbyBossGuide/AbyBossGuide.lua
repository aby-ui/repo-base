...
BG.data = {
    ["伤逝剧场"] = {
        [1] = { id = 2397, name = "狭路相逢", text = "3码分散别炸队友，先杀放瘟疫箭的，再杀受诅者，注意驱散", },
    ...
    ["凋魂之殇"] = {
        ...
        [4] = { id = 2404, name = "斯特拉达玛侯爵", text = "躲小怪，躲触须，绿圈T来踩，谁亮先躲谁", },
        author = "哚秘书@NGA",
        id = 1183,
    },
    ["塞兹仙林的迷雾"] = {
        [1] = { id = 2400, name = "英格拉·马洛克", text = "先打高的再打矮的", },
        [2] = { id = 2402, name = "唤雾者", text = "躲箭头，找不同，远离狐狸打boss", },
        [3] = { id = 2405, name = "特雷德奥瓦", text = "暴食护盾必须断，有啥躲啥，连线扯断，别被小怪追上", },
        author = "哚秘书@NGA",
        id = 1184,
    },
    ["彼界"] = {
        [1] = { id = 2408, name = "夺灵者哈卡", text = "红圈分散不传染，哈卡之子放角落击杀，鲜血屏障谁都打，远离鲜血弹幕", },
        [2] = { id = 2409, name = "法力风暴夫妇", text = "分散站，拆炸弹，电锯开减伤，点名不要慌", },
    ...
    ["晋升高塔"] = {
        ...
        [4] = { id = 2412, name = "疑虑圣杰德沃丝", text = "躲冲锋，黑球炸前进罩子，运球放中间，拿矛插脑袋", },
        author = "哚秘书@NGA",
        id = 1186,
    },
--    ["暗影界"] = {
...
--    },
    ["赎罪大厅"] = {
        [1] = { id = 2406, name = "哈尔吉亚斯，罪污巨像", text = "出红圈无限被恐，躲好脚下玻璃渣", },
    ...
    ["赤红深渊"] = {
        ...
        [4] = { id = 2407, name = "卡尔将军", text = "躲，躲，躲，躲，躲，暗天飓风提前开盾进去躲", },
        author = "哚秘书@NGA",
        id = 1189,
    },
    ["通灵战潮"] = {
        [1] = { id = 2395, name = "凋骨", text = "清完小怪再打！！", },
        [2] = { id = 2391, name = "收割者阿玛厄斯", text = "打龙→打断法师→嘲讽战士→杀弓箭手 提前分工 杀人再杀龙", },
        [3] = { id = 2392, name = "外科医生缝肉", text = "胖子读钩子，钩子钩boss", },
        [4] = { id = 2396, name = "缚霜者纳尔佐", text = "白圈远离队友再驱散，aoe原地转圈圈，不要方", },
        author = "哚秘书@NGA",
        id = 1182,
    },
}
