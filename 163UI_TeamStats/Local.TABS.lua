...
TS.DATA_VERSION = 20201120

--abyuiPW
TS.VERSION_BOSSES = { -13784, "艾", -14068, "恩", -14460, "帝" } -- -13322, "吉", -13418, "乌", 12110, "阿" -11874, "基" -- -11195, "古", --引领潮流 -11194, "萨", -11581, "海", 引领潮流：Ahead of the Curve: 千钧一发 Cutting Edge:

local RES = {
  {
      tab = "总览",
      ids = { 7399, -14531, -14532 }, -- -14145, "S4大师", -13781, "S3大师", -13449, "S2大师"
      widths = { 70, 50, 50 },
      names = { "大秘次数", "S1征服", "S1大师"},
