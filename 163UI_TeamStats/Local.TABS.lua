...
TS.DATA_VERSION = 20210716

--abyuiPW
TS.VERSION_BOSSES = { -14460, "帝", -15134, "希" } -- -13784, "艾", -14068, "恩", -13322, "吉", -13418, "乌", 12110, "阿" -11874, "基" -- -11195, "古", --引领潮流 -11194, "萨", -11581, "海", 引领潮流：Ahead of the Curve: 千钧一发 Cutting Edge:

local RES = {
  {
      tab = "总览",
      ids = { {-15045,-15046,-15047,-15048,-15049,-15050,-15051,-15052}, -15077, -15078, }, -- -14531, -14532, "S1征服", "S1大师", -14145, "S4大师", -13781, "S3大师", -13449, "S2大师"
      widths = { 64, 54, 54 },
      names = { "钥石英雄", "S2征服", "S2大师" },
      tips = { "钥石英雄光辉成就（账号共享，限时完成20层史诗钥石副本）", "《暗影国度》钥石征服者（账号共享，任意角色史诗钥石评分1500分）", "《暗影国度》钥石大师（账号共享，任意角色史诗钥石评分2000分）", },
...
table.insert(TABS, {
    ...
    any_done = true,
    ids = {
        {-15135}, {-14461}, {-14069}, {-13785}, {-13419}, {-13323}, {-12535},
    ...
    tips = {
        "千钧一发：希尔瓦娜斯", "千钧一发：德纳修斯大帝", "千钧一发：恩佐斯", "千钧一发：艾萨拉", "千钧一发：乌纳特", "千钧一发：吉安娜", "千钧一发：戈霍恩",
    ...
    names = { "希瓦", "大帝", "恩佐", "艾萨", "乌纳", "珍娜", "戈霍", "阿古", "基丹", "古尔", "海拉", "萨维", "阿克", "黑手", "悬槌", "小吼", "莱登", "雷神", "永春", "恐心", "魔古" },
})
...
----------------------------------------------------------------------------------------------------
-- 一个boss一个boss的列出不同难度
local instanceList = { '纳斯利亚堡' } --'尼奥罗萨，觉醒之城', '翡翠梦魇', '勇气试炼', '暗夜要塞', '萨格拉斯之墓', '安托鲁斯，燃烧王座', '奥迪尔' }
