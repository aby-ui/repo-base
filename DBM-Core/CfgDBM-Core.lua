...
U1RegisterAddon("DBM-Party-Dragonflight", { title = "巨龙时代5人副本", });
U1RegisterAddon("DBM-DragonIsles", { title = "龙岛模块", }); --TODO:abyui10
U1RegisterAddon("DBM-VaultoftheIncarnates", { title = "化身宝库模块", }); --TODO:abyui10
U1RegisterAddon("DBM-Affixes", { title = "副本词缀模块", });
U1RegisterAddon("DBM-Party-Vanilla", { title = "经典旧世5人副本", });
