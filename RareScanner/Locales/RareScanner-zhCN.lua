...
if AL then
	...
	AL["NOTE_150342"] = "在事件[Drill Rig DR-TR35]激活期间可用"
	AL["NOTE_150394"] = "你需要把他带到坐标63.38，那里有一个蓝色闪电装置，当NPC触碰到闪电时他会爆炸，然后你就可以拾取战利品。"
	AL["NOTE_151124"] = "你需要在事件[Drill Rig DR-JD99]激活期间（坐标59.67）从小怪身上拾取[被砸烂的运输中继器]，然后在这个机器上使用"
	AL["NOTE_151202"] = "你需要在岸边用水里的电线塔连接电线才能召唤他"
	AL["NOTE_151308"] = "在事件[Drill Rig]激活期间可用"
	AL["NOTE_151569"] = "你需要一个[百尺诱饵]来召唤他。"
	AL["NOTE_151627"] = "你需要在平台的机器上使用一个[蒸发器放热线圈]。"
	AL["NOTE_151884"] = "仅在米露恩发放日常任务[Aid from Nordrassil]时有效。该日常要求你在树底下找蘑菇，当你点击一个蘑菇时它会停滞，你需要在它消失前再点2个蘑菇，NPC才会出现"
	AL["NOTE_151933"] = "你需要使用[机械兽能量背包]才能击杀他（你可以在坐标60.41找到图纸）"
	AL["NOTE_152007"] = "它会在这个区域游荡，所以坐标可能不太精确。"
	AL["NOTE_152113"] = "在事件[Drill Rig DR-CC88]激活期间可用"
	AL["NOTE_152569"] = "你靠近他时他会告诉你一个他讨厌的颜色，你要到坐标63.41被染成这个颜色，然后回来找他，他就会攻击你。"
	AL["NOTE_153000"] = "它会在这个区域游荡，所以坐标可能不太精确。"
	AL["NOTE_153200"] = "在事件[Drill Rig DR-JD41]激活期间可用"
	AL["NOTE_153205"] = "在事件[Drill Rig DR-JD99]激活期间可用"
	AL["NOTE_153206"] = "在事件[Drill Rig DR-TR28]激活期间可用"
	AL["NOTE_153228"] = "需要击杀很多[Upgraded Sentry]才会在这个区域出现"
	AL["NOTE_154225"] = "需要使用[个人时光置换器]访问他的接口，这个物品是克罗米发放日常任务[The Other Place]的奖励品"
	AL["NOTE_154701"] = "在事件[Drill Rig DR-CC61]激活期间可用"
	AL["NOTE_154739"] = "在事件[Drill Rig DR-CC73]激活期间可用"
	...
	AL["NOTE_326395"] = "激活桌上箱子旁的[神秘装置]开始小游戏。需要将三个三角形分开，点击宝珠交换位置。"
	AL["NOTE_326396"] = "激活地上箱子旁的[神秘装置]开始小游戏。需要将2个方形分开，点击宝珠交换位置"
	AL["NOTE_326397"] = "激活地上箱子旁的[神秘装置]开始小游戏。需要将三个红色的附文连成一线。"
	AL["NOTE_326398"] = "激活桌上箱子旁的[神秘装置]开始小游戏。需要将四个青色的附文连成一线。"
	...
	AL["NOTE_326408"] = "在水下的洞里，入口在湖的南面(坐标74,40)"
