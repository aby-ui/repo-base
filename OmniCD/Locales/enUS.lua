...
L["Show Numbers for Cooldowns must be enabled in Blizzard's Interface/ActionBars menu."] = "Show Numbers for Cooldowns must be enabled in Blizzard's Interface/ActionBars menu."
