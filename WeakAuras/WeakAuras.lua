...
BINDING_NAME_WEAKAURASTOGGLE = BINDING_HEADER_WEAKAURAS .. L["Toggle Options Window"]
BINDING_NAME_WEAKAURASPROFILINGTOGGLE = BINDING_HEADER_WEAKAURAS .. L["Toggle Performance Profiling Window"]
BINDING_NAME_WEAKAURASPRINTPROFILING = BINDING_HEADER_WEAKAURAS .. L["Print Profiling Results"]
